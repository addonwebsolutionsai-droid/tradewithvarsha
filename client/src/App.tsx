      ...
      <main className={PUBLIC_MODE
        ...
        {PUBLIC_MODE ? (
          <Routes>
            ...
            <Route path="/pro-setups"     element={<PublicProSetupsPage />} />
            <Route path="/master"         element={<PublicMasterSetupsPage />} />
            <Route path="/money-printer"  element={<PublicMoneyPrinterPage />} />
